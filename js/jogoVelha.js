...
caixa1.addEventListener('click', () => {
	if(jogadorDaVez == 1) {
		caixas[0].style.backgroundImage = 'url(img/x.png)'
		jogadorDaVez = 2
		...
		caixas[0].style.backgroundImage = 'url(img/bola.png)'
		jogadorDaVez = 1
...
caixa2.addEventListener('click', () => {
	if(jogadorDaVez == 1) {
		caixas[1].style.backgroundImage = 'url(img/x.png)'
		jogadorDaVez = 2
    sequencias[0] = sequencias[0] + 'o'
		sequencias[4] = sequencias[4] + 'o'
	} 
	else if(jogadorDaVez == 2) {
		caixas[1].style.backgroundImage = 'url(img/bola.png)'
		jogadorDaVez = 1
		sequencias[0] = sequencias[0] + 'x'
...
caixa3.addEventListener('click', () => {
	if(jogadorDaVez == 1) {
		caixas[2].style.backgroundImage = 'url(img/x.png)'
		jogadorDaVez = 2
		sequencias[0] = sequencias[0] + 'o'
		...
		caixas[2].style.backgroundImage = 'url(img/bola.png)'
		jogadorDaVez = 1
		sequencias[0] = sequencias[0] + 'x'
...
caixa4.addEventListener('click', () => {
	if(jogadorDaVez == 1) {
		caixas[3].style.backgroundImage = 'url(img/x.png)'
		jogadorDaVez = 2
		sequencias[1] = sequencias[1] + 'o'
		sequencias[3] = sequencias[3] + 'o'
	} 
	else if(jogadorDaVez == 2) {
		caixas[3].style.backgroundImage = 'url(img/bola.png)'
		jogadorDaVez = 1
...
caixa5.addEventListener('click', () => {
	if(jogadorDaVez == 1) {
		caixas[4].style.backgroundImage = 'url(img/x.png)'
		jogadorDaVez = 2
		sequencias[1] = sequencias[1] + 'o'
		sequencias[4] = sequencias[4] + 'o'
		sequencias[6] = sequencias[6] + 'o'
		...
		caixas[4].style.backgroundImage = 'url(img/bola.png)'
		jogadorDaVez = 1
		sequencias[1] = sequencias[1] + 'x'
		sequencias[4] = sequencias[4] + 'x'
		sequencias[6] = sequencias[6] + 'x'
...
caixa6.addEventListener('click', () => {
	if(jogadorDaVez == 1) {
		caixas[5].style.backgroundImage = 'url(img/x.png)'
		jogadorDaVez = 2
		sequencias[1] = sequencias[1] + 'o'
		sequencias[5] = sequencias[5] + 'o'
	} 
	else if(jogadorDaVez == 2) {
		caixas[5].style.backgroundImage = 'url(img/bola.png)'
		jogadorDaVez = 1
		sequencias[1] = sequencias[1] + 'x'
		sequencias[5] = sequencias[5] + 'x'
	}
...
caixa7.addEventListener('click', () => {
	if(jogadorDaVez == 1) {
		caixas[6].style.backgroundImage = 'url(img/x.png)'
		jogadorDaVez = 2
		...
		caixas[6].style.backgroundImage = 'url(img/bola.png)'
		jogadorDaVez = 1
...
caixa8.addEventListener('click', () => {
	if(jogadorDaVez == 1) {
		caixas[7].style.backgroundImage = 'url(img/x.png)'
		jogadorDaVez = 2
		sequencias[2] = sequencias[2] + 'o'
		sequencias[4] = sequencias[4] + 'o'
	} 
	else if(jogadorDaVez == 2) {
		caixas[7].style.backgroundImage = 'url(img/bola.png)'
		jogadorDaVez = 1
		sequencias[2] = sequencias[2] + 'x'
		sequencias[4] = sequencias[4] + 'x'
	}
...
caixa9.addEventListener('click', () => {
	if(jogadorDaVez == 1) {
		caixas[8].style.backgroundImage = 'url(img/x.png)'
		jogadorDaVez = 2
		sequencias[2] = sequencias[2] + 'o'
		sequencias[5] = sequencias[5] + 'o'
		sequencias[6] = sequencias[6] + 'o'
		...
		caixas[8].style.backgroundImage = 'url(img/bola.png)'
		jogadorDaVez = 1
		sequencias[2] = sequencias[2] + 'x'
		sequencias[5] = sequencias[5] + 'x'
		sequencias[6] = sequencias[6] + 'x'
...
function limpaGrade(item, index) {
	caixas[index].style.backgroundImage = 'url(img/blank-velha.png)'
}
